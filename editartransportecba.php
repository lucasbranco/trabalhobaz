...
<form class="form-horizontal" action="../../model/cadastro_bdtcba.php" method="post" id="mural">
    <!-- Form Name -->
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="saidaba">Barra de São joão(saída)</label>  
  <div class="col-md-4">
  <input id="saidaba" name="saidaba" type="text" placeholder="00:00" class="form-control input-md" required="">
  <span class="help-block">Digite o Horário de Saída de Barra de São joão</span>  
  </div>
</div>
